...
_start:	movia r13, KEY_BASE	# r8 <- KEY_BASE
		...
		movi r10, 1123	# set parameter for max counter value
		...
		movi r20, 99	# parameter for the 99 hundredths
...
counter:
	...
	andi r21, r11, 0b00001111111	# only look at the lower 7 bits
	ble r21, r20, counter	# if it is less than or equal to 99, keep looping
	subi r11, r11, 100	# else decrease 100
	addi r11, r11, 128	# increment on the second
	ble r11, r10, counter	# if r11 is less than or equal to 1023 (8:99), keep looping
