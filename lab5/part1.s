...
We loop through all possible numbers from 0 to F
For each number, we display it on all 6 HEX displays and pause for a bit to see if they're displayed correctly
At the end, we blank out all 6 HEX displays to see if that works correctly as well
